...
package com.bc.meta.selector.htmlparser;
 ...
 */
public class AttributeContextHtmlparser 
        implements AttributeTestProvider<Node>, BiFunction<String, Node, String> {
    ...
    @Override
    public String apply(String propertyName, Node node) {
        final String value;
